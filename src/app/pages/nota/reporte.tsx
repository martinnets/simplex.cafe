...
export function NotaReportePage() {
    ...
    const { toPDF, targetRef } = usePDF({
        filename: 'Nota de Venta-' + nota.nota + '.pdf',
                                ...
                                <div className="d-flex flex-column gap-7 gap-md-10">
                                    ...
                                    <div className="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                        <div className="flex-root d-flex flex-column">
                                            <span className="text-muted">Nota ID</span>
                                            <span className="fs-5">#{nota.nota}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                            <span className="text-muted">Fecha</span>
                                            <span className="fs-5">{nota.fecha}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                            <span className="text-muted">Referencia</span>
                                            <span className="fs-5">{nota.referencia}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                            <span className="text-muted">Moneda</span>
                                            <span className="fs-5">{nota.moneda}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                            ...
                                            <table className="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody className="fw-semibold text-gray-600">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-gray-900 fs-3 fw-bolder text-end">{nota.total}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
