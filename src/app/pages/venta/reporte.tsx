...
export function VentaReportePage() {
    ...
    const idventa = queryParameters.get("id")
    const { toPDF, targetRef } = usePDF({
        filename: 'Documento-' + venta.serie+String(venta.numero).padStart(8, '0') + '.pdf',
    ...
    useEffect(() => {
        ...
        ventaDataService.getventaById(idventa)
                        ...
                        <div className="p-10">
                            <div className="card card-dashed">
                                <div className="card-body text-center">
                                    <h1 className="text-dark">Venta</h1>
                                ...
                                <div className="d-flex flex-column gap-7 gap-md-10">
                                    ...
                                    <div className="d-flex flex-column flex-sm-row gap-7 gap-md-10 fw-bold">
                                        <div className="flex-root d-flex flex-column">
                                            ...
                                            <span className="fs-5">#{venta.serie+'-'+String(venta.numero).padStart(8, '0')}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                            <span className="text-muted">Fecha</span>
                                            <span className="fs-5">{venta.fecha}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                        ...
                                        <div className="flex-root d-flex flex-column">
                                            ...
                                            <span className="fs-5">{venta.moneda}</span>
                                        </div>
                                        <div className="flex-root d-flex flex-column">
                                        ...
                                        <div className="table-responsive border-bottom mb-9">
                                            <table className="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                ...
                                                <tbody className="fw-semibold text-gray-600">
                                                    ...
                                                    <>
                                                    <tr>
                                                        <td colSpan={4} className="fs-3 text-gray-900 fw-bold text-end">  Sub Total</td>
                                                        <td className="text-gray-900 fs-3 fw-bolder text-end">
                                                        {Intl.NumberFormat('es-ES', {style:'decimal'}).format(venta.subtotal)}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colSpan={4} className="fs-3 text-gray-900 fw-bold text-end">  IGV</td>
                                                        <td className="text-gray-900 fs-3 fw-bolder text-end">
                                                            {Intl.NumberFormat('es-ES', {style:'decimal'}).format(venta.igv)}</td>
                                                    </tr>
                                                    </>:<></>}
                                                    <tr>
                                                        <td colSpan={4} className="fs-3 text-gray-900 fw-bold text-end">  Total</td>
                                                        <td className="text-gray-900 fs-3 fw-bolder text-end">
                                                        {Intl.NumberFormat('es-ES', {style:'decimal'}).format(venta.total)}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
