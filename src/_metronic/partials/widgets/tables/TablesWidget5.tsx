    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Pedidos / Ventas Recientes </span>
          <span className='text-muted mt-1 fw-semibold fs-7'>Resumen</span>
        </h3>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <span className='fw-semibold d-block'>Monturas </span>
                    </td>
                    <td className='text-end text-muted fw-semibold'>Producto</td>
                    <td className='text-end'>
                      <span className='badge badge-light-success'>Pagado</span>
                    </td>
